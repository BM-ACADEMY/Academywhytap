...
import { CheckCircle, Clock, Users, Star, ChevronRight, Award, Briefcase, BarChart2 } from 'lucide-react';
...
const curriculum = [
  { module: 'Module 1', title: 'Data Foundations', topics: ['Excel Mastery', 'SQL Basics', 'Data Cleaning'] },
  { module: 'Module 2', title: 'Python for Analytics', topics: ['NumPy & Pandas', 'Data Wrangling', 'Matplotlib & Seaborn'] },
  { module: 'Module 3', title: 'Visualization & BI', topics: ['Power BI Dashboards', 'Tableau Basics', 'Storytelling with Data'] },
  { module: 'Module 4', title: 'Advanced Analytics', topics: ['Machine Learning Intro', 'Predictive Modeling', 'AI Tools'] },
  { module: 'Module 5', title: 'Projects & Placement', topics: ['Industry Projects', 'Case Studies', 'Interview Prep'] },
];

const stats = [
  { value: '3 / 6 Months', label: 'Duration' },
  { value: '5900+', label: 'Students Enrolled' },
  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      <div className="relative py-16 md:py-24 overflow-hidden" style={{ background: 'linear-gradient(135deg, #02182b 0%, #05243b 100%)' }}>
        <div className="absolute inset-0 opacity-10" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1400&q=80)', backgroundSize: 'cover', backgroundPosition: 'center' }} />
        <div className="relative max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-10 items-center">
          <div>
            <div className="flex items-center gap-2 mb-4 flex-wrap">
              ...
              <ChevronRight size={13} className="text-gray-500" />
              <span className="text-white/60 text-[12px] font-bold uppercase tracking-wider">Data Analysis</span>
            </div>
            <span className="inline-block bg-[#e8be66] text-[#05243b] text-[10px] font-black px-3 py-1 rounded-full mb-4 tracking-wider uppercase">Trending</span>
            <h1 className="text-3xl md:text-5xl font-extrabold text-white leading-tight mb-4">
              Certification in<br />
              <span className="text-[#14937a]">AI-Powered Data Analytics</span>
            </h1>
            <p className="text-slate-300 text-base md:text-lg mb-8 leading-relaxed max-w-xl">
              Turn raw data into powerful business insights. Learn Python, SQL, Power BI and AI-powered analytics tools with hands-on projects.
            </p>
            <div className="flex flex-wrap gap-5 mb-8">
              ...
              <div className="flex items-center gap-2 text-slate-300 text-sm"><Users size={16} className="text-[#14937a]" /><span>5900+ Students</span></div>
              <div className="flex items-center gap-2 text-slate-300 text-sm"><Star size={16} fill="#e8be66" stroke="#e8be66" /><span>4.7 Rating</span></div>
            </div>
          ...
          <div className="hidden md:block">
            <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=700&q=80" alt="Data Analysis" className="rounded-[2rem] shadow-2xl w-full h-80 object-cover border-4 border-white/10" />
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-16 grid md:grid-cols-3 gap-12">
        <div className="md:col-span-2 space-y-16">
          <section>
            <div className="flex items-center gap-3 mb-8">
              <BarChart2 size={32} className="text-[#14937a]" />
        ...
        <div className="relative">
          <div className="bg-white border border-slate-100 rounded-[2rem] shadow-xl p-8 sticky top-24 overflow-hidden">
            ...
            <img src="https://images.unsplash.com/photo-1504868584819-f8e8b4b6d7e3?w=400&q=80" alt="course" className="rounded-2xl w-full h-44 object-cover mb-6 border border-slate-100 shadow-sm" />
            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="flex items-center gap-3 text-slate-600 font-bold text-[14px]"><Users size={18} className="text-[#14937a]" /><span>Students: <strong className="text-[#05243b]">5900+</strong></span></div>
              <div className="flex items-center gap-3 text-slate-600 font-bold text-[14px]"><Award size={18} className="text-[#14937a]" /><span>Certification: <strong className="text-[#05243b]">Professional Certification</strong></span></div>
