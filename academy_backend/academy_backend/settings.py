...
# ------------------------
# Load env (local vs Render)
# ------------------------
ENV = os.getenv("ENV", "local")  # local | prod

if os.environ.get("RENDER"):
    # Render uses dashboard env vars only
    pass
elif ENV == "prod":
...
# ------------------------
# Allowed hosts ⭐ (env-based, no override)
# ------------------------
ALLOWED_HOSTS = os.getenv("ALLOWED_HOSTS", "").split(",")
...
# ------------------------
# MongoDB connection (UNCHANGED LOGIC ✅)
# ------------------------
MONGO_ENV = os.getenv("MONGO_ENV", "local")
...
# ------------------------
# REST Framework ⭐ (fixed duplicate bug)
# ------------------------
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": [
...
# ------------------------
# CORS + CSRF ⭐ (env-based, admin + client)
# ------------------------
CORS_ALLOWED_ORIGINS = os.getenv("CORS_ALLOWED_ORIGINS", "").split(",")
CSRF_TRUSTED_ORIGINS = os.getenv("CSRF_TRUSTED_ORIGINS", "").split(",")
